...
SENSITIVITY_SCENARIOS = [
    ...
    },
    {
        ...
        "stage_name": "单帧筛选",
        "changed_parameters": "SNR=0.90, Amp=0.70, Score=1.85",
        "overrides": {"SNR_QUANTILE": 0.90, "AMP_QUANTILE": 0.70, "SIGNAL_SCORE_MIN": 1.85},
    },
    {
        "scenario_name": "强点筛选偏松",
        "stage_name": "单帧筛选",
        "changed_parameters": "SNR=0.80, Amp=0.60, Score=1.65",
        "overrides": {"SNR_QUANTILE": 0.80, "AMP_QUANTILE": 0.60, "SIGNAL_SCORE_MIN": 1.65},
    },
    {
        "scenario_name": "聚类邻域偏小",
        "stage_name": "单帧聚类",
        "changed_parameters": "eps=0.95",
        "overrides": {"DBSCAN_EPS": 0.95},
    },
    {
        "scenario_name": "聚类邻域偏大",
        "stage_name": "单帧聚类",
        "changed_parameters": "eps=1.25, min_cluster=4",
        "overrides": {"DBSCAN_EPS": 1.25, "MIN_CLUSTER_SIZE": 4},
    },
    {
        "scenario_name": "关联门限偏严",
        "stage_name": "多帧关联",
        "changed_parameters": "距离=4.0, 矢量速度差=6.0, 转向=105",
        "overrides": {
    ...
    },
    {
        ...
        "stage_name": "多帧关联",
        "changed_parameters": "距离=6.0, 矢量速度差=10.0, 转向=145",
        "overrides": {
            "MAX_LINK_DISTANCE_KM": 6.0,
            "MAX_VECTOR_VELOCITY_DIFF_KMH": 10.0,
    ...
    },
    {
        ...
        "stage_name": "质量确认",
        "changed_parameters": "直线性=0.50, 最大步长=2.50, 平均步长=1.20, 转向=145",
        "overrides": {
            "MIN_TRACK_STRAIGHTNESS": 0.50,
            "MAX_TRACK_STEP_KM": 2.50,
            "MAX_MEAN_TRACK_STEP_KM": 1.20,
            "MAX_DIRECTION_CHANGE_DEG": 145.0,
        },
    },
]
